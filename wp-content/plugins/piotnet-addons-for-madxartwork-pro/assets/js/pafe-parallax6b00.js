...
jQuery(document).ready(function( $ ) {
	...
	if($(".pafe-parallax-widget").length > 0) {
		$(".pafe-parallax-widget:not([data-pafe-parallax-new-version='']) .madxartwork-widget-container").each(function(){
			pafeParallaxElement( $(this), $(this).closest('.pafe-parallax-widget') );
		});

		$(".pafe-parallax-widget[data-pafe-parallax-new-version=''] .madxartwork-widget-container").each(function(){
			pafeParallaxElementNewVersion( $(this), $(this).closest('.pafe-parallax-widget') );
		});
	}

	if($(".pafe-parallax-column").length > 0) {
		$(".pafe-parallax-column:not([data-pafe-parallax-new-version='']) .madxartwork-column-wrap").each(function(){
			pafeParallaxElement( $(this), $(this).closest('.pafe-parallax-column') );
		});

		$(".pafe-parallax-column[data-pafe-parallax-new-version=''] .madxartwork-column-wrap").each(function(){
